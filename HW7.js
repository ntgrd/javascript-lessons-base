...
const snake = {
    ...
    growUp() {
        ...
        foodCounter.render(this.body.length - 1);
...
const foodCounter = {
    ...
    init() {
        ...
        this.eatenFoodBlock = document.createElement('div');
        // console.log(this.eatenFoodBlock);
        // console.log(game_wrap);
        this.eatenFoodBlock.classList.add('Food_counter');
        game_wrap.appendChild(this.eatenFoodBlock);
    },
    render(foodCount) {
        this.eatenFoodBlock.textContent = `Количество съеденной еды = ${foodCount}`;
...
const game = {
    ...
    reset() {
        ...
        this.foodCounter.render(this.snake.body.length - 1);
console.log(this.snake.body.length - 1);
        this.render();
    ...
    tickHandler() {
        ...
        this.snake.makeStep();
        this.barrier.barrierTime = this.barrier.barrierTime - 1;
        if (this.barrier.barrierTime <= 0) {
            this.barrier.barrierTime = 10;
            this.barrier.setCoordinates(this.getRandomFreeCoordinates());
        }
        this.render();
    },
